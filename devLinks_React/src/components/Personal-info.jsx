...
//             setPhoto(photoURL); // Update the preview URL
//             setPhotoFile(file); // Store the actual File object
//         }
//     };
...
//             user.append('imageFile', photoFile); // Send the File object instead of the URL
